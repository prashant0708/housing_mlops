...
import sys,os
from house.entity.artifact_entity import ModelPusherArtifact,ModelEvaluationArtifact
from house.entity.config_entity import ModelPusherConfig
import shutil
...
class ModelPusher:
    ...
    def export_model(self)-> ModelPusherArtifact:
        try:
            ...
            ## we can call a function to save model to azure blob storage /google storage / s3 bucket
