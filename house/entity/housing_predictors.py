...
from house.util.util import load_object
import pandas as pd
   ...
   def __init__(self,
    ...
    def get_housing_input_data_frame(self):
        try:
            ...
            housing_data_frame=pd.DataFrame(housing_input_dict)
...
class HousingPredictor:
    ...
    def get_latest_model_path(self):
        try:
            ...
            latest_folder=str(max(folder_name))
            latest_model_dir=os.path.join(self.model_dir,latest_folder)
