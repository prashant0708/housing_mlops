from house.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, \
    ModelTrainerConfig, ModelEvaluationConfig, ModelPusherConfig, TrainingPipelineConfig
from house.util.util import read_yaml_file
...
class Configuration:
    ...
    def get_data_ingestion_config(self)->DataIngestionConfig:
        try:
            ...
            data_ingestion_artifact_dir=os.path.join(artifacts_dir,DATA_INGESTION_ARTIFACT_DIR,self.time_stamp)
            ...
            ingested_test_dir=os.path.join(ingested_data_dir,
                                           data_ingestion_info[DATA_INGESTION_TEST_DIR]
